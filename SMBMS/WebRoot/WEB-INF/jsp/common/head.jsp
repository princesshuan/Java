...
<!--头部-->
    <header class="publicHeader">
        ...
        <div class="publicHeaderR">
            <p><span>下午好！</span><span style="color: #fff21b"> ${currentuser }</span> , 欢迎你！</p>
     ...
     <div class="left">
         ...
         <nav>
             ...
             <c:if test="${userrole==1 }">
              ...
              <li><a href="${pageContext.request.contextPath }/goods/goodslist">商品管理</a></li>
              ...
              <li><a href="${pageContext.request.contextPath }/user/findpwd">密码修改</a></li>
              <li><a href="${pageContext.request.contextPath }/index/logout">退出系统</a></li>
             </c:if>
