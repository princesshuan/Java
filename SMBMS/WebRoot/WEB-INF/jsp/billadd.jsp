...
<div class="right">
     ...
     <div class="providerAdd">
         <form id="billForm" name="billForm" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath }/bill/addbill">
             ...
             <div>
                    ...
                    <label for="goodsPicture">商品图片：</label>
                   	<input type="file" name="attachs" id="goodsPicture"/>
                   	<font color="red"></font>
                </div>
             <div>
