...
<%@include file="./common/head.jsp"%>
  ...
  <div class="right">
      ...
      <div class="providerAdd">
          ...
          <form id="providerForm" name="providerForm" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath }/provider/updateprovider">  
			...
			<font color="red"></font>
              ...
              <div>
                    ...
                    <label for="proLicence">营业执照：</label>
                   	<input type="file" name="attachs" id="proLicence" value="${provider.prolicence }"/>
                   	<font color="red"></font>
                </div>
